...
'完成 Button 组件文档', completed: true }, { text: '编写 Card 组件示例', completed: true }, { text:
'更新 CHANGELOG', completed: false }, ], bord} }); activeTaskIndex.value = closestIndex; }; //
任务数据 const tasks = ref([ { id: 1, tag: 'WORK', tagColor: 'rgba(74, 64, 224, 1)', timeRange:
'08:00-10:30', actualDuration: '1h 15min', title: '早间深度工作：界面排版优化', subTasks: [ { text:
'梳理 Chronicle 核心视觉层次', completed: true }, { text: '更新排版网格规范文档', completed: false
}, { text: '提交初稿至内部评审小组', completed: false }, ], quote:
'专注力是创造力的核心：保持沉浸式设计状态。', borderColor: 'rgba(74, 64, 224, 1)', bgColor:
'rgba(255, 255, 255, 1)', }, { id: 2, tag: 'MEETING', tagColor: 'rgba(248, 160, 16, 1)', timeRange:
'10:30-12:00', actualDuration: '30min', title: '产品策略同步会议', subTasks: [ { text: '确认 Q3
产品路线图', completed: false }, { text: '讨论用户反馈优先级', completed: false }, ], borderColor:
'rgba(248, 160, 16, 1)', bgColor: 'rgba(255, 250, 240, 1)', }, { id: 3, tag: 'REST', // 从 mock
获取指定日期的任务 tasks.value = getDailyTasksByDate(newDate); tagColor: 'rgba(0, 105, 71, 1)',
timeRange: '14:00-15:00', actualDuration: '45min', title: '午休与恢复', subTasks: [{ text: '冥想 15
分钟', completed: true }], quote: '休息是为了更好的出发。', borderColor: 'rgba(0, 105, 71, 1)',
bgColor: 'rgba(240, 255, 250, 1)', }, { id: 4, tag: 'WORK', tagColor: 'rgba(74, 64, 224, 1)',
timeRange: '15:00-17:30', actualDuration: '2h 30min', title: '组件库文档编写', subTasks: [ { text:
'完成 Button 组件文档', completed: true }, { text: '编写 Card 组件示例', completed: true }, { text:
'更新 CHANGELOG', completed: false }, ], bord} }); activeTaskIndex.value = closestIndex; }; //
任务数据 const tasks = ref([ { id: 1, tag: 'WORK', tagColor: 'rgba(74, 64, 224, 1)', timeRange:
'08:00-10:30', actualDuration: '1h 15min', title: '早间深度工作：界面排版优化', subTasks: [ { text:
...
timeRange: '15:00-17:30', actualDuration: '2h 30min', title: '组件库文档编写', subTasks: [ { text:
'完成 Button 组件文档', completed: true }, { text: '编写 Card 组件示例', completed: true }, { text:
'更新 CHANGELOG', completed: false }, ], bord'完成 Button 组件文档', completed: true }, { text:
'编写 Card 组件示例', completed: true }, { text: '更新 CHANGELOG', completed: false }, ], bord} });
activeTaskIndex.value = closestIndex; }; // 任务数据 const tasks = ref([ { id: 1, tag: 'WORK',
tagColor: 'rgba(74, 64, 224, 1)', timeRange: '08:00-10:30', actualDuration: '1h 15min', title:
'早间深度工作：界面排版优化', subTasks: [ { text: '梳理 Chronicle 核心视觉层次', completed: true },
{ text: '更新排版网格规范文档', completed: false }, { text: '提交初稿至内部评审小组', completed:
false }, ], quote: '专注力是创造力的核心：保持沉浸式设计状态。', borderColor: 'rgba(74, 64, 224,
1)', bgColor: 'rgba(255, 255, 255, 1)', }, { id: 2, tag: 'MEETING', tagColor: 'rgba(248, 160, 16,
1)', timeRange: '10:30-12:00', actualDuration: '30min', title: '产品策略同步会议', subTasks: [ {
text: '确认 Q3 产品路线图', completed: false }, { text: '讨论用户反馈优先级', completed: false }, ],
borderColor: 'rgba(248, 160, 16, 1)', bgColor: 'rgba(255, 250, 240, 1)', }, { id: 3, tag: 'REST', //
从 mock 获取指定日期的任务 tasks.value = getDailyTasksByDate(newDate); tagColor: 'rgba(0, 105, 71,
1)', timeRange: '14:00-15:00', actualDuration: '45min', title: '午休与恢复', subTasks: [{ text:
'冥想 15 分钟', completed: true }], quote: '休息是为了更好的出发。', borderColor: 'rgba(0, 105, 71,
1)', bgColor: 'rgba(240, 255, 250, 1)', }, { id: 4, tag: 'WORK', tagColor: 'rgba(74, 64, 224, 1)',
timeRange: '15:00-17:30', actualDuration: '2h 30min', title: '组件库文档编写', subTasks: [ { text:
'完成 Button 组件文档', completed: true }, { text: '编写 Card 组件示例', completed: true }, { text:
'更新 CHANGELOG', completed: false }, ], bord} }); activeTaskIndex.value = closestIndex; }; //
任务数据 const tasks = ref([ { id: 1, tag: 'WORK', tagColor: 'rgba(74, 64, 224, 1)', timeRange:
...
timeRange: '15:00-17:30', actualDuration: '2h 30min', title: '组件库文档编写', subTasks: [ { text:
'完成 Button 组件文档', completed: true }, { text: '编写 Card 组件示例', completed: true }, { text:
'更新 CHANGELOG', completed: false }, ], bord